...
- **Ajuste de Color y Espaciado de Cabecera**: Se actualizó el color de los títulos a `#164584` y se redujo la separación vertical de las dos líneas del título a `28 pt` (cambiando la coordenada Y de la segunda línea de 615 a 632) para compactar el diseño del encabezado.
