odoo.define('openeducat_backend_theme.sidemenu', function (require) {
    "use strict";
...
odoo.define('openeducat_backend_theme.sidemenu.AppsMenu', function (require) {
    "use strict";
    var AppsMenu = require('web.AppsMenu');
    var SideMenu = require('openeducat_backend_theme.sidemenu');
    AppsMenu.include({
...
odoo.define('openeducat_backend_theme.sidemenu.webclient', function (require) {
    "use strict";
