odoo.define('openeducat_backend_theme.BackendThemeCustomizer', function (require) {
    "use strict";
    ...
    var BackendThemeCustomizer = Widget.extend({
        template: 'openeducat_backend_theme.theme_customizer.menu',
        ...
        _render: function() {
            this.$('.f-theme-customizer-toggler').parent().append(QWeb.render('openeducat_backend_theme.theme_customizer.panel', this));
            var panelContent = this.$('.f-theme-customizer-content')
            var adminPanel = QWeb.render('openeducat_backend_theme.theme_customizer.panel.admin', this);
            var userPanel = QWeb.render('openeducat_backend_theme.theme_customizer.panel.user', this);
            if (session.is_admin) {
