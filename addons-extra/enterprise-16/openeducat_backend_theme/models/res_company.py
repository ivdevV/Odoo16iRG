...
XML_ID = "openeducat_backend_theme._assets_primary_variables"
SCSS_URL = '/openeducat_backend_theme/static/src/scss/backend_theme_customizer/colors.scss' # noqa
...
class ResCompany(models.Model):
    ...
    theme_color_brand = fields.Char("Theme Brand Color", default="#424242")
    ...
    def write(self, vals):
        ...
        if self:
            for rec in self:
                ...
                url = "/openeducat_backend_theme/static/src/scss/backend_theme_customizer/colors.scss" # noqa
    ...
    def get_values(self):
        ...
        colors = self.env['openeducat_backend_theme.scss_editor'].get_values(
