odoo.define('openeducat_grading.gradebook_by_batch', function(require) {
    "use strict";
    ...
    var GradeBookByBatch = AbstractAction.extend({
        ...
        start: function() {
            ...
            this._rpc({
                ...
                method: "get_student_data_grade_book_by_batch",
...
//            this.$CommentContainer.remove();
    ...
    core.action_registry.add('grade_book_grid_by_batch', GradeBookByBatch);

    return GradeBookByBatch;
});
