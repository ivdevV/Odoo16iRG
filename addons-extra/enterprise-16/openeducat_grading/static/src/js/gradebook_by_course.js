odoo.define('openeducat_grading.gradebook_by_course', function(require) {
    "use strict";
    ...
    var GradeBookByCourse = AbstractAction.extend({
        ...
        start: function() {
            ...
            this._rpc({
                ...
                method: "get_student_data_grade_book_by_course",
...
//            this.$CommentContainer.remove();
    ...
    core.action_registry.add('grade_book_grid_by_course', GradeBookByCourse);

    return GradeBookByCourse;
});
