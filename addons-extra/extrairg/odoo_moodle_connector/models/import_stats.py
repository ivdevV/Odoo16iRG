...
class MoodleImportStats(models.Model):
    _name = constants.MOODLE_IMPORT_STATS_MODEL
    _description = constants.MOODLE_IMPORT_STATS_MODEL_DESC
    ...
    upd_event = fields.Integer(string="Update Event")
