...
class DiplomadoReportPDF(models.AbstractModel):
    ...
    def generate_diplomado_pdf(self, data):
        ...
        c.drawCentredString(page_width / 2.0, page_height - 61 * mm, "Hace constar que")
        ...
        p_aprobacion.drawOn(c, 20 * mm, page_height - 106 * mm)
        ...
        p_title.drawOn(c, 16 * mm, page_height - 128 * mm)

        # 7. Frase final
        c.setFont('Helvetica-Oblique', 13)
        c.setFillColorRGB(0.423, 0.478, 0.443)  # #6C7A71
        c.drawCentredString(page_width / 2.0, page_height - 147 * mm, "que acredita haber superado con aprovechamiento las mencionadas enseñanzas.")

        # 8. Barcelona, a ...
        c.setFont('Helvetica', 13)
        c.setFillColorRGB(0.423, 0.478, 0.443)
        c.drawCentredString(page_width / 2.0, page_height - 161 * mm, "Barcelona, a %s" % data.get('issue_date', ''))
