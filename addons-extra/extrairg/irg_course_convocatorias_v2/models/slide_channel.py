...
class SlideChannel(models.Model):
    ...
    # Campos relacionados editables para la configuración Online desde la misma pantalla (Opción A)
    irg_online_description_html = fields.Html(
        string='Descripción Online',
        related='irg_online_channel_id.description_html',
        readonly=False,
    )
    irg_online_enroll = fields.Selection(
        string='Matrícula Online',
        related='irg_online_channel_id.enroll',
        readonly=False,
    )
    irg_online_visibility = fields.Selection(
        string='Visibilidad Online',
        related='irg_online_channel_id.visibility',
        readonly=False,
    )
    irg_online_promote_strategy = fields.Selection(
        string='Estrategia de promoción Online',
        related='irg_online_channel_id.promote_strategy',
        readonly=False,
    )
    irg_online_enroll_msg = fields.Html(
        string='Mensaje de inscripción Online',
        related='irg_online_channel_id.enroll_msg',
        readonly=False,
    )
    irg_online_enroll_group_ids = fields.Many2many(
        'res.groups',
        string='Grupos de matrícula Online',
        related='irg_online_channel_id.enroll_group_ids',
        readonly=False,
    )
    irg_online_upload_group_ids = fields.Many2many(
        'res.groups',
        string='Grupos de subida Online',
        related='irg_online_channel_id.upload_group_ids',
        readonly=False,
    )

    # Campos de Karma relacionados
    irg_online_karma_gen_slide_vote = fields.Integer(
        string='Votar diapositiva Online',
        related='irg_online_channel_id.karma_gen_slide_vote',
        readonly=False,
    )
    irg_online_karma_gen_channel_finish = fields.Integer(
        string='Terminar curso Online',
        related='irg_online_channel_id.karma_gen_channel_finish',
        readonly=False,
    )
    irg_online_karma_gen_channel_rank = fields.Integer(
        string='Alcanzar rango Online',
        related='irg_online_channel_id.karma_gen_channel_rank',
        readonly=False,
    )
