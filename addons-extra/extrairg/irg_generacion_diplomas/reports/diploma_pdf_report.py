...
class DiplomaReportPDF(models.AbstractModel):
    ...
    def generate_diploma_pdf(self, data, diploma_type='digital'):
        ...
        side_margin = page_width * 0.071
        gutter = page_width * 0.024
        ...
        self._draw_text_in_column(c, "L'Institut Raimon Gaja atorga el present diploma de", 
                                   left_col_x, y, col_width, font_regular, sf(12), align='right')
        self._draw_text_in_column(c, "El Instituto Raimon Gaja otorga el presente diploma de", 
                                   right_col_x, y, col_width, font_regular, sf(12), align='left')
        ...
        # --- "a" ---
        y -= sp(30)
        self._draw_centered_text(c, "a", y, font_regular, sf(14), page_width)
        ...
        self._draw_text_in_column(c, body_cat_1, left_col_x, y, col_width, font_regular, sf(11), align='right')
        y -= sp(15)
        self._draw_text_in_column(c, body_cat_2, left_col_x, y, col_width, font_regular, sf(11), align='right')
        y -= sp(25)
        self._draw_text_in_column(c, body_cat_3, left_col_x, y, col_width, font_regular, sf(11), align='right')
        y -= sp(15)
        self._draw_text_in_column(c, body_cat_4, left_col_x, y, col_width, font_regular, sf(11), align='right')
        ...
        self._draw_text_in_column(c, body_es_1, right_col_x, y_es, col_width, font_regular, sf(11), align='left')
        y_es -= sp(15)
        self._draw_text_in_column(c, body_es_2, right_col_x, y_es, col_width, font_regular, sf(11), align='left')
        y_es -= sp(25)
        self._draw_text_in_column(c, body_es_3, right_col_x, y_es, col_width, font_regular, sf(11), align='left')
        y_es -= sp(15)
        self._draw_text_in_column(c, body_es_4, right_col_x, y_es, col_width, font_regular, sf(11), align='left')
        ...
        self._draw_text_in_column(c, f"Barcelona, a {date_cat}", left_col_x, y, col_width, font_regular, sf(12), align='center')
        self._draw_text_in_column(c, f"Barcelona, a {date_es}", right_col_x, y, col_width, font_regular, sf(12), align='center')
        ...
        # Text Names (Aligned)
        y -= sp(10)
        self._draw_text_in_column(c, "Raimon Gaja", left_col_x, y, col_width, font_bold, sf(14), align='center')
        self._draw_text_in_column(c, "Grecia Malcotti", right_col_x, y, col_width, font_bold, sf(14), align='center')
        
        y -= sp(15)
        self._draw_text_in_column(c, "Director", left_col_x, y, col_width, font_regular, sf(11), align='center')
        self._draw_text_in_column(c, "Directora Académica", right_col_x, y, col_width, font_regular, sf(11), align='center')
        
        y -= sp(13)
        self._draw_text_in_column(c, "Fundador", left_col_x, y, col_width, font_regular, sf(11), align='center')
        self._draw_text_in_column(c, "Directora Acadèmica", right_col_x, y, col_width, font_regular, sf(11), align='center')
        ...
        c.setFont(font_bold, sf(9))
        c.drawString(qr_x, qr_y - sp(12), f"Nº Registro: {registry}")
