...
class WebsiteSlidesBunny(WebsiteSlides):
    ...
    @http.route('/slides/slide/set_completed_bunny', website=True, type="json", auth="public")
    def slide_set_completed_bunny(self, slide_id, completion_type):
