...
`;let Se=class extends ke{constructor(){super(...arguments),this.kind="primary",this.size="m",this.type="button",this.href=void 0,this.block=!1}get submits(){return"submit"===this.type}bindEvents(){this.on("click",(()=>{this.submits&&this.$form?.requestSubmit()}))}render(){return this.href?he.qy`
        <a
          class="button"
          href=${this.href}
        >
    ...
    `}};Se.formAssociated=!0,Se.styles=Ce,(0,pe.Cg)([(0,xe.MZ)({type:String,reflect:!0})],Se.prototype,"kind",void 0),(0,pe.Cg)([(0,xe.MZ)({type:String,reflect:!0})],Se.prototype,"size",void 0),(0,pe.Cg)([(0,xe.MZ)({type:String,reflect:!0})],Se.prototype,"type",void 0),(0,pe.Cg)([(0,xe.MZ)({type:String,reflect:!0})],Se.prototype,"href",void 0),(0,pe.Cg)([(0,xe.MZ)({type:Boolean,reflect:!0})],Se.prototype,"block",void 0),Se=(0,pe.Cg)([(0,xe.EM)("mon-button")],Se);const ze=he.AH`
  :host {
    cursor: pointer;
    display: flex;
    gap: var(--mon-spacing);
...
`;let Ee=class extends ke{constructor(){super(...arguments),this.selected=!1,this.bindEvents=()=>{this.on("mouseenter",(()=>{this.dispatch("hover",{value:this.value,hovered:!0})})),this.on("mouseleave",(()=>{this.dispatch("hover",{value:this.value,hovered:!1})}))}}render(){return he.qy`
      <slot name="icon"></slot>
      <span class="content">
        <slot></slot>
      </span>
    `}};Ee.formAssociated=!0,Ee.styles=ze,(0,pe.Cg)([(0,xe.MZ)({type:String,reflect:!0})],Ee.prototype,"name",void 0),(0,pe.Cg)([(0,xe.MZ)({type:String,reflect:!0})],Ee.prototype,"value",void 0),(0,pe.Cg)([(0,xe.MZ)({type:Boolean,reflect:!0})],Ee.prototype,"selected",void 0),(0,pe.Cg)([(0,xe.MZ)({type:String,reflect:!0})],Ee.prototype,"for",void 0),Ee=(0,pe.Cg)([(0,xe.EM)("mon-menu-item")],Ee);const Ie=he.AH`
  * {
    box-sizing: border-box;
  }
...
`;let Me=class extends ke{constructor(){super(...arguments),this.open=!1,this.value=null,this.onSubmit=t=>{this.value=t.detail.value,this.open=!1},this.onClickOutside=t=>{this.hasWithin(t.detail.$target)||(this.open=!1)},this.onClickTrigger=()=>{this.open=!this.open},this.onKeyUp=t=>{"ArrowDown"===t.key&&(t.preventDefault(),this.open=!0)},this.onSlotChange=()=>{this.value||(this.value=this.$selected?.value??null)},this.renderLabel=()=>{if(this.value)return this.$$$(`mon-menu-item[value="${this.value}"]`)[0]?.innerText}}get $selected(){return this.$$$("mon-menu-item[selected]")[0]}renderTrigger(){const t=this.renderLabel()??he.qy`<slot name="placeholder">Choose an item…</slot>`;return he.qy`
    ...
    `:he.qy`
        ...
        ></slot>
      `}render(){return he.qy` ${this.renderTrigger()} ${this.renderMenu()} `}};var qe;Me.styles=Ie,(0,pe.Cg)([(0,xe.MZ)({type:String,reflect:!0})],Me.prototype,"name",void 0),(0,pe.Cg)([(0,xe.MZ)({type:Boolean,reflect:!0})],Me.prototype,"open",void 0),(0,pe.Cg)([(0,xe.wk)()],Me.prototype,"value",void 0),Me=(0,pe.Cg)([(0,xe.EM)("mon-dropdown")],Me);const Le=he.AH`
  * {
    box-sizing: border-box;
  }
...
`;let Be=class extends ke{constructor(){super(...arguments),this.bordered=!0,this.floating=!1,this.autofocusit=!1,this.value=null,this.pressing=!1,this.bindEvents=()=>{this.on("change",this.onChange),this.on("click",this.onClick),this.on("keydown",this.onKeydown),this.on("keyup",this.onKeyup),this.on("mouseover",this.onMouseover),this.collectOff(fe("mousedown",window,(t=>{t.target instanceof HTMLElement&&!this.hasWithin(t.target)&&this.dispatch("clickoutside",{$target:t.target})})))},this.submit=()=>{this.dispatch("mon-menu:submit",{name:this.name,value:this.value})},this.choose=t=>{const e=t.closest("label")?.querySelector("input");e&&(e.checked=!0,e.focus(),e.dispatchEvent(new Event("change",{bubbles:!0})))},this.focusFirstApplicableItem=()=>{const t=this.$selected??this.$$$("mon-menu-item")[0];t&&this.choose(t)},this.onMouseover=t=>{t.target instanceof Ee&&this.choose(t.target)},this.onChange=t=>{this.value=t.target.value??null,this.$slotted.forEach((t=>{const e=t.querySelector("mon-menu-item");e&&e.toggleAttribute("selected",e.value===this.value)}))},this.onClick=t=>{!this.pressing&&t.target instanceof HTMLInputElement&&requestAnimationFrame((()=>{this.submit()}))},this.onKeyup=t=>{const{key:e}=t;"Enter"!==e&&" "!==e||this.submit(),this.pressing=!1},this.onKeydown=()=>{this.pressing=!0},this.onSlotChange=()=>{this.wrapSlots(),this.autofocusit&&this.focusFirstApplicableItem()},this.wrapSlots=()=>{this.$slotted.forEach((t=>{if(!(t instanceof Ee))return;const e=document.createElement("div"),n=document.createElement("li");t.replaceWith(e),(0,he.XX)(he.qy`
          <label ?for=${t.for}>
            ${(0,pe.gn)(this,qe,"f").call(this,t)} ${t}
          </label>
        `,n),e.replaceWith(n)}))},qe.set(this,(t=>null!=t.for?he.qy``:he.qy`
      <input
        type="radio"
        role="menuitem"
        checked=${t.selected}
    ...
    `}};function Re(t){(0,o.append_styles)(t,"svelte-1ooljvd",".mondrian__suspense-3tgPBN.mondrian__--loading-3irTkJ{visibility:hidden}")}qe=new WeakMap,Be.styles=Le,(0,pe.Cg)([(0,xe.MZ)({type:String,reflect:!0})],Be.prototype,"name",void 0),(0,pe.Cg)([(0,xe.MZ)({type:Boolean,reflect:!0})],Be.prototype,"bordered",void 0),(0,pe.Cg)([(0,xe.MZ)({type:Boolean,reflect:!0})],Be.prototype,"floating",void 0),(0,pe.Cg)([(0,xe.MZ)({type:Boolean,reflect:!0})],Be.prototype,"autofocusit",void 0),Be=(0,pe.Cg)([(0,xe.EM)("mon-menu")],Be),n(2466),o.SvelteComponent,n(9777),o.SvelteComponent,o.SvelteComponent,o.SvelteComponent,o.SvelteComponent,o.SvelteComponent,o.SvelteComponent,o.SvelteComponent,o.SvelteComponent,o.SvelteComponent,o.SvelteComponent,n(2732),o.SvelteComponent,o.SvelteComponent,o.SvelteComponent,o.SvelteComponent,o.SvelteComponent,o.SvelteComponent,o.SvelteComponent,o.SvelteComponent,o.SvelteComponent,o.SvelteComponent,o.SvelteComponent;const Ne=t=>({isLoading:1&t}),je=t=>({isLoading:t[0]});function Ke(t){let e,n;const i=t[2].default,s=(0,o.create_slot)(i,t,t[1],je);return{c(){e=(0,o.element)("div"),s&&s.c(),(0,o.attr)(e,"class","mondrian__suspense-3tgPBN"),(0,o.toggle_class)(e,"mondrian__--loading-3irTkJ",t[0])},m(t,i){(0,o.insert)(t,e,i),s&&s.m(e,null),n=!0},p(t,[r]){s&&s.p&&(!n||3&r)&&(0,o.update_slot_base)(s,i,t,t[1],n?(0,o.get_slot_changes)(i,t[1],r,Ne):(0,o.get_all_dirty_from_scope)(t[1]),je),(!n||1&r)&&(0,o.toggle_class)(e,"mondrian__--loading-3irTkJ",t[0])},i(t){n||((0,o.transition_in)(s,t),n=!0)},o(t){(0,o.transition_out)(s,t),n=!1},d(t){t&&(0,o.detach)(e),s&&s.d(t)}}}function Te(t,e,n){let{$$slots:o={},$$scope:i}=e;const s=function(){const t=new Set;return(0,d.setContext)($e,t),t}();let r=!0;return(0,d.onMount)((()=>{Promise.all(s).then((()=>{n(0,r=!1)}))})),t.$$set=t=>{"$$scope"in t&&n(1,i=t.$$scope)},[r,i,o]}class De extends o.SvelteComponent{constructor(t){super(),(0,o.init)(this,t,Te,Ke,o.safe_not_equal,{},Re)}}const Oe=De,Ze={[q](t,e,n,o){const i="self"===t.targetId?n:o[t.targetId];!1===e.hovered?tt.get(i.id)?.revert():tt.get(i.id)?.set(t.targetState)},[L](t,e,n,o){const i="self"===t.targetId?n:o[t.targetId];!1===e.hovered?nt.get(i.id)?.set(!t.targetVisibility):nt.get(i.id)?.set(t.targetVisibility)}},Xe=(t,e)=>{const n=ot("trigger",t,(t=>{const{itemId:n,triggerId:o,...i}=t.detail,s=e[n];if(!s)throw new Error(`Could not execute trigger ${o} on item ${n} because the item could not be found.`);const r=s?.triggers.find((t=>t.id===o));if(!r)throw new Error(`Could not execute trigger ${o} on item ${n} because the trigger could not be found.`);const a=Ze[r.action];if(!a)throw new Error(`Could not execute trigger ${o} on item ${n} because an appropriate handler for its '${r.action}' action could not be found.`);a(r,i,s,e)}));return{destroy(){n()}}};function He(t){(0,o.append_styles)(t,"svelte-cm9a2g",".mondrian__preview-NTLm89{display:flex;justify-content:center;position:relative;z-index:0}")}function We(t){let e,n;return e=new Oe({props:{$$slots:{default:[Pe]},$$scope:{ctx:t}}}),{c(){(0,o.create_component)(e.$$.fragment)},m(t,i){(0,o.mount_component)(e,t,i),n=!0},p(t,n){const o={};128&n&&(o.$$scope={dirty:n,ctx:t}),e.$set(o)},i(t){n||((0,o.transition_in)(e.$$.fragment,t),n=!0)},o(t){(0,o.transition_out)(e.$$.fragment,t),n=!1},d(t){(0,o.destroy_component)(e,t)}}}function Fe(t){let e,n,i,s;return{c(){e=(0,o.element)("div"),n=(0,o.text)("Block "),i=(0,o.text)(t[0]),s=(0,o.text)(" could not be loaded")},m(t,r){(0,o.insert)(t,e,r),(0,o.append)(e,n),(0,o.append)(e,i),(0,o.append)(e,s)},p(t,e){1&e&&(0,o.set_data)(i,t[0])},i:o.noop,o:o.noop,d(t){t&&(0,o.detach)(e)}}}function Pe(t){let e,n,i,s,r,a;return n=new me({props:{itemId:t[6].id,isRoot:!0}}),{c(){e=(0,o.element)("div"),(0,o.create_component)(n.$$.fragment),(0,o.attr)(e,"class","mondrian__preview-NTLm89")},m(l,d){(0,o.insert)(l,e,d),(0,o.mount_component)(n,e,null),s=!0,r||(a=(0,o.action_destroyer)(i=Xe.call(null,e,t[2])),r=!0)},p:o.noop,i(t){s||((0,o.transition_in)(n.$$.fragment,t),s=!0)},o(t){(0,o.transition_out)(n.$$.fragment,t),s=!1},d(t){t&&(0,o.detach)(e),(0,o.destroy_component)(n),r=!1,a()}}}function Ye(t){let e,n,i,s;const r=[Fe,We],a=[];function l(t,e){return 1===e?function(t){const e=t.slice(),n=e[2][e[3]];return e[6]=n,e}(t):t}return e=function(t,e){return void 0===t[1]||void 0===t[3]?0:1}(t),n=a[e]=r[e](l(t,e)),{c(){n.c(),i=(0,o.empty)()},m(t,n){a[e].m(t,n),(0,o.insert)(t,i,n),s=!0},p(t,[o]){n.p(l(t,e),o)},i(t){s||((0,o.transition_in)(n),s=!0)},o(t){(0,o.transition_out)(n),s=!1},d(t){t&&(0,o.detach)(i),a[e].d(t)}}}function Ue(t,e,n){let{manifest:o}=e,{blockumentId:i}=e;const s=Symbol("LearnComponent"),r=o.blockuments?.[i],a=o.items??{},l=r?.children[0]?.id;return Ut.addManifest(s,o),(0,d.setContext)("isLearn",!0),tt.resetAll(),nt.resetAll(),Object.values(a).forEach((t=>{tt.add(t.id,(0,Q.readable)(t.initialState)),nt.add(t.id,(0,Q.readable)(t.initialVisible))})),(0,d.onDestroy)((()=>{Ut.removeManifest(s)})),t.$$set=t=>{"manifest"in t&&n(4,o=t.manifest),"blockumentId"in t&&n(0,i=t.blockumentId)},[i,r,a,l,o]}class Ve extends o.SvelteComponent{constructor(t){super(),(0,o.init)(this,t,Ue,Ye,o.safe_not_equal,{manifest:4,blockumentId:0},He)}}const Je=Ve;var Qe=n(2834),Ge=n.n(Qe);const tn=((t,e={},n="div")=>o=>{const i=(0,Qe.useRef)(null),s=(0,Qe.useRef)(null),[r,a]=(0,Qe.useState)(!1);return(0,Qe.useEffect)((()=>{const e=/on([A-Z]{1,}[a-zA-Z]*)/,n=/watch([A-Z]{1,}[a-zA-Z]*)/;s.current=new t({target:i.current,props:o});const r=[];for(const t in o){const i=t.match(e),a=t.match(n);null!=i&&"function"==typeof o[t]&&s.current.$on(`${i[1][0].toLowerCase()}${i[1].slice(1)}`,o[t]),null!=a&&"function"==typeof o[t]&&r.push([`${a[1][0].toLowerCase()}${a[1].slice(1)}`,o[t]])}if(r.length>0){const t=s.current.$$.update;s.current.$$.update=function(){r.forEach((([t,e])=>{if(null!==s.current){const n=s.current.$$.props[t];e(s.current.$$.ctx[n])}})),t.apply(null)}}return()=>{null!==s.current&&s.current.$destroy()}}),[o]),(0,Qe.useEffect)((()=>{r?null!==s.current&&s.current.$set(o):a(!0)}),[o,r]),Ge().createElement(n,{ref:i,style:e})})(Je),en=t=>Ge().createElement(tn,{...t})}}]);
//# sourceMappingURL=b6b581bf.js.map