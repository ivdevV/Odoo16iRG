odoo.define('isep_sale_subscription_extension.grid_controller', function (require) {
    "use strict";
    ...
    core.action_registry.add('subscription_report_grid_extension', SubscriptionGridController);
