...
class SaleOrderDateFilterWizard(models.TransientModel):
    ...
    def action_apply_filter(self):
        ...
        return {
            ...
            'view_mode': 'tree,form',
            'views': [
                (self.env.ref('isep_sale_subscription_extension.isep_sale_subscription_cartera_tree').id, 'tree'),
                (False, 'form'),
            ],
    ...
    def action_print_report(self):
        self.ensure_one()
        return self.env.ref('isep_sale_subscription_extension.report_sale_subscription_due_pdf').report_action(self)
