...
| [irg_mail_n8n_webhook](./irg_mail_n8n_webhook.md) | Redirige correo saliente a n8n con cola de reintentos | `irg.mail.n8n.delivery` (nuevo), `mail.mail`, `res.config.settings` | Instalable |
