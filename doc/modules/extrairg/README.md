...
| [irg_practice_agreement_specific](./irg_practice_agreement_specific.md) | Convenios específicos nacional, internacional y HomeClass síncronas | `practice.agreement`, `practice.request` | Instalable |
