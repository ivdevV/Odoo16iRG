...
- **Ajustes de Diseño en Plantilla Word:**
  ...
  - **Decoración inferior derecha:** Reutiliza el helper global de `irg_gradebook_certificates` para insertar `static/src/img/RCOS.png` como arcos azules anclados a la esquina inferior derecha de la página, por detrás del texto, sin desplazar cierre ni firma.
