...
| :--- | :--- | :--- | :--- |
| **Título en Español** | `660` | Centrado | `Inter-Bold` / `Helvetica-Bold` (24 pt, `#3092C0`) |
| **Título en Catalán** | `632` | Centrado | `Inter-Bold` / `Helvetica-Bold` (24 pt, `#3092C0`) |
| **Nombres del Curso (Cat / Es)** | `510` | Columna (`545.27` / `645.27`) | `Inter-Bold` (32 pt, `#02448A`), Salto de 36 pt |
...
- **Azul Claro (Títulos)**: `HexColor('#3092C0')` $\rightarrow$ Hex `#3092C0`
- **Azul Oscuro (Nombre del Máster)**: `HexColor('#02448A')` $\rightarrow$ Hex `#02448A`
